...
**{{ website.company_detailed_legal_name }}, a company incorporated under the Companies Act, 1956 having its registered office at {{ website.company_registered_address }} and corporate office at {{ website.company_address }} (hereinafter referred to as “Eko”) owns and operates {{ website.website_url }} (“Website/Platform”).**
 ...
 * By listing or updating your cellular phone information on the website/social media platform of {{ website.company_name }} ("Eko"), you authorize Eko to call or send SMS text messages / whatsapp messages, using an automatic telephone dialing system or by way of any pre-recorded message or through any tele caller to your cell phone to provide information regarding its services including downloading of apps.
...
* Nodal Desk – Monday to Friday from 10:00 a.m. to 6:00 p.m – {{ website.company_name }}, {{ website.company_address }}.
